...
console.log("deleted", booksArray);
// Iteration 4 | Estimated Reading Time
// Your code here:
booksArray.forEach((book) => {
  const timeToRead = Math.ceil((book.pages * 500) / 90);
  book.readingTime = timeToRead;
});
console.log("time to read", booksArray);
